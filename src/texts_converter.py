...
def get_line_data(line, data_index)-> str:
...
def get_block_info_by_RGB(color_data, block_data_list)-> list:
...
def generate_lua_table(data)-> str:
    lua_table = "data={"
